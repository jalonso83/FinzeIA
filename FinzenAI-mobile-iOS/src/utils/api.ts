...
// API de RevenueCat (In-App Purchases)
export const revenueCatAPI = {
  // Verificar compra con RevenueCat y sincronizar DB
  verifyPurchase: () =>
    api.post('/subscriptions/rc/verify-purchase'),

  // Restaurar compras de RevenueCat
  restorePurchases: () =>
    api.post('/subscriptions/rc/restore'),

  // Obtener estado de suscripción (incluye paymentProvider)
  getStatus: () =>
