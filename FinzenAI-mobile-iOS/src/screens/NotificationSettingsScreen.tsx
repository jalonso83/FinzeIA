...
export default function NotificationSettingsScreen({ onClose, onOpenPlans }: NotificationSettingsScreenProps) {
  ...
  const { hasBudgetAlerts, canUseProNotifications } = useSubscriptionStore();
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.settingsCard}>
          ...
          <TouchableOpacity
            ...
            onPress={() => !canUseProFeatures && onOpenPlans && onOpenPlans()}
          ...
          {canUseProFeatures && preferences?.antExpenseAlertsEnabled && (
            <View style={styles.antConfigContainer}>
              ...
              <View style={styles.antConfigItem}>
                ...
                <Slider
                  key={`ant-amount-slider-${loading ? 'loading' : 'loaded'}`}
                  style={styles.slider}
                  minimumValue={50}
                  maximumValue={2000}
                  step={50}
              ...
              <View style={styles.antConfigItem}>
                ...
                <Slider
                  key={`ant-freq-slider-${loading ? 'loading' : 'loaded'}`}
                  style={styles.slider}
                  minimumValue={2}
                  maximumValue={10}
                  step={1}
        ...
        >
          ...
          <Slider
            key={`threshold-slider-${loading ? 'loading' : 'loaded'}`}
            style={styles.slider}
            minimumValue={50}
            maximumValue={95}
            step={5}
        ...
        <Text style={styles.sectionTitle}>Recordarme contribuir a mis metas</Text>
        <View style={styles.settingsCard}>
